        ...
        var i = {
            ...
            return (
              ...
              ('remote' !== e.data.type && 'local' !== e.data.type) ||
                ...
                'local' === e.data.type &&
                  ...
                  (o.dataSet = o.originalDataSet = i.dataMapCallback(
                    e.data.source
                  )),
                i.dataRender()),
              a ||
          ...
          paging: function(a, n) {
            var l = {
              ...
              paste: function() {
                t.each(t.unique(i.getOption('toolbar.placement')), function(
                  e,
                  a
                ) {
                  'bottom' === a &&
          ...
          columnHide: function() {
            ...
            t.each(n.columns, function(n, i) {
              if (void 0 !== i.responsive) {
                var l = i.field,
                  r = t.grep(t(o.table).find('.m-datatable__cell'), function(
                    e,
                    a
                  ) {
                  ...
                  if (e == t(n).text()) {
                    var l =
                      t(n)
                        ...
                        .index() + 1;
                    return (
                      (o.API.record = o.API.value = i.getOneRow(
                        o.tableBody,
                        l
                      )),
                      o
          ...
          hideColumn: function(e) {
            ...
            var a = t.grep(t(o.table).find('.m-datatable__cell'), function(
              a,
              n
            ) {
          ...
          rows: function(e) {
            return (
              (i.nodeTr = i.recentNode = t(o.tableBody)
                .find(e)
          ...
          column: function(e) {
            return (
              (i.nodeCols = i.recentNode = t(o.tableBody).find(
          ...
          visible: function(e) {
            if (t(i.recentNode.length)) {
              ...
              if (i.recentNode === i.nodeCols) {
                ...
                if (i.isLocked()) {
                  var l = t(i.recentNode).closest('.m-datatable__lock--scroll')
                    .length;
                  l
                    ? (o += a.left.length + 1)
...
var mLayout = (function() {
  ...
  return {
    ...
    initHeader: function() {
      ...
      (e = mUtil.get('m_header')),
        ...
        'hide' == mUtil.attr(e, 'm-minimize-mobile')
          ? ((n.minimize.mobile = {}),
            (n.minimize.mobile.on = 'm-header--hide'),
            (n.minimize.mobile.off = 'm-header--show'))
          : (n.minimize.mobile = !1),
        'hide' == mUtil.attr(e, 'm-minimize')
          ? ((n.minimize.desktop = {}),
            (n.minimize.desktop.on = 'm-header--hide'),
            (n.minimize.desktop.off = 'm-header--show'))
          : (n.minimize.desktop = !1),
        (t = mUtil.attr(e, 'm-minimize-offset')) && (n.offset.desktop = t),
        (t = mUtil.attr(e, 'm-minimize-mobile-offset')) &&
          (n.offset.mobile = t),
        (header = new mHeader('m_header', n)),
        (a = new mOffcanvas('m_header_menu', {
          overlay: !0,
    ...
    initAside: function() {
      var a, n;
      (a = mUtil.get('m_ver_menu')),
        (n =
          '1' === mUtil.attr(a, 'm-menu-dropdown') ? 'dropdown' : 'accordion'),
        ...
        (function() {
          ...
          for (
            var o = mUtil.findAll(
                a,
                '.m-menu__item--submenu-fullheight .m-menu__submenu > .m-menu__wrapper'
              ),
              i = 0,
              l = o.length;
            i < l;
